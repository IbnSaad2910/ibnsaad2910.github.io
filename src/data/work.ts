...
export const work = [
  {
    ...
    company: "atQuest Solutions Sdn Bhd",
    region: "Petaling Jaya, Selangor",
    description:
      "Learn and contribute to .NET backend (ASP.NET Core Web API) under guidance: routes, controllers, services, DI, logging. Fix bugs, write small enhancements, and help with QA, code reviews, and documentation. Support real enterprise features: authentication/authorization, validation, error handling, and basic performance checks.",
